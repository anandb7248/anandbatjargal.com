    ...
    <AboutSection id="about">
      ...
      <ContentContainer>
        ...
        <ProfileText>
          ...
          <br />
          <br />
          I enjoy learning the latest technologies and building software that
          bring value to users.
          <br />
          <br />
          I want to build software products that make life easier and more
          efficient with everything that working just right
          <br />
          with an emphasis on great intuitive design.
          <br />
          <br />
          As a constant learner, I continually take online courses to improve my
          knowledge and skillsets as a software engineer,
          <br />
          as well as to apply what I learned with projects.
          <br />
          <br />
          Please feel free to email me at anandb7248@gmail.com or connect with
